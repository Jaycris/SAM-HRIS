            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                        ...
                        <div class="p-2 h-full flex items-center justify-center">
                            <div class="grid grid-cols-3 gap-4 w-full">
                                <div class="px-2 py-2 flex flex-col justify-center items-center text-center border-slate-200 dark:border-zinc-500 ltr:border-r rtl:border-l last:border-0">
                                    <h6 class="mb-0 font-bold text-xl">N/A</h6>
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-12">
                            <div class="col-span-8 md:col-span-9">
                                <p class="text-slate-500 dark:text-slate-200">Total Leave Request</p>
                ...
                <div class="col-span-12 md:order-4 lg:col-span-6 2xl:col-span-3 card">
                    <div class="card-body">
                        <div class="grid grid-cols-12">
                            <div class="col-span-8 md:col-span-9">
                                <p class="text-slate-500 dark:text-slate-200">Total Approved Leave</p>
                                <h5 class="mt-3 mb-4"><span class="counter-value" data-target="0">0</span></h5>
                            </div>
                            <div class="col-span-4 md:col-span-3">
                 ...
                 <div class="col-span-12 md:order-5 2xl:order-6 lg:col-span-6 2xl:col-span-3 card">
                    <div class="card-body">
                        <div class="grid grid-cols-12">
                            <div class="col-span-8 md:col-span-9">
                                <p class="text-slate-500 dark:text-slate-200">Total Pending Leave</p>
                                <h5 class="mt-3 mb-4"><span class="counter-value" data-target="0">0</span></h5>
                            </div>
                            <div class="col-span-4 md:col-span-3">
                                <div id="hiredCandidates" data-chart-colors='["bg-yellow-500"]' dir="ltr" class="grow apex-charts"></div>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 mt-3">
                            <p class="text-slate-500 dark:text-slate-200">This Month</p>
                ...
                <div class="col-span-12 md:order-6 2xl:order-7 lg:col-span-6 2xl:col-span-3 card">
                    <div class="card-body">
                        <div class="grid grid-cols-12">
                            <div class="col-span-8 md:col-span-9">
                                <p class="text-slate-500 dark:text-slate-200">Total Rejected Leave</p>
                                <h5 class="mt-3 mb-4"><span class="counter-value" data-target="0">0</span></h5>
                            </div>
                            <div class="col-span-4 md:col-span-3">
